...
function parseTransformation({ zodRef, schemas, useOutput }) {
  ...
  return (0, ts_deepmerge_1.default)(
    Object.assign(
      Object.assign(
        Object.assign({}, zodRef.description ? { description: zodRef.description } : {}),
        input,
      ),
...
function parseObject({ zodRef, schemas, useOutput }) {
  ...
  if (
    !(
      ...
      ((_a = zodRef._def.catchall) === null || _a === void 0 ? void 0 : _a._def.typeName) ===
        'ZodNever'
    )
  )
...
function parseArray({ schemas, zodRef, useOutput }) {
  ...
  return (0, ts_deepmerge_1.default)(
    Object.assign({ type: 'array', items: generateSchema(zodRef.element, useOutput) }, constraints),
    zodRef.description ? { description: zodRef.description } : {},
    ...schemas,
  )
}
