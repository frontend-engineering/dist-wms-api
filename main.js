...
AppController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof flowda_engine_1.SchemaService !== "undefined" && flowda_engine_1.SchemaService) === "function" ? _a : Object, typeof (_b = typeof wms_services_1.PostService !== "undefined" && wms_services_1.PostService) === "function" ? _b : Object])
], AppController);
...
AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        controllers: [app_controller_1.AppController, flowda_engine_1.DataController, task_controller_1.TaskController, user_controller_1.UserController, process_controller_1.ProcessController],
        providers: [
            {
...
let DataService = DataService_1 = class DataService {
    ...
    parseId(resource, id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const modelName = (0, flowda_shared_1.toModelName)(resource);
            ...
            this.logger.log('id field:' + idField.type);
            return nId;
        });
    }
    put(path, values) {
