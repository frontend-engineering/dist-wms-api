...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_g = typeof wms_services_1.CreateIncomingInspectionRecordSchemaDto !== "undefined" && wms_services_1.CreateIncomingInspectionRecordSchemaDto) === "function" ? _g : Object]),
    tslib_1.__metadata("design:returntype", void 0)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, common_1.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_h = typeof wms_services_1.CreateOperationInspectionRecordSchemaDto !== "undefined" && wms_services_1.CreateOperationInspectionRecordSchemaDto) === "function" ? _h : Object]),
    tslib_1.__metadata("design:returntype", void 0)
...
AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            ...
            process_controller_1.ProcessController,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TableFilterService = exports.RemoveTableFilterSchemaDto = exports.QueryTableFilterSchemaDto = void 0;
const tslib_1 = __webpack_require__("tslib");
const inversify_1 = __webpack_require__("inversify");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CustomError = exports.K3CloudIdentifyInfoSymbol = exports.CustomZodSchemaSymbol = exports.PrismaZodSchemaSymbol = exports.URLSymbol = exports.APISymbol = exports.ServiceSymbol = exports.PrismaClientSymbol = void 0;
...
let DataService = DataService_1 = class DataService {
    ...
    put(reqUser, path, values) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.log(`auth info ${JSON.stringify(reqUser, null, 2)} values: ${JSON.stringify(param)}`);
            return ret;
        });
    }
    post(reqUser, path, values) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (createParamRet['x-unique']) {
                ...
                this.logger.log(`auth info ${JSON.stringify(reqUser, null, 2)} POST(update) path: ${path}, values: ${JSON.stringify(param)}`);
                return ret;
            }
            else {
                const ret = yield this.prisma[resource].create(param);
                this.logger.log(`auth info ${JSON.stringify(reqUser, null, 2)} POST path: ${path}, values: ${JSON.stringify(param)}`);
                return ret;
            }
        });
    }
    remove(reqUser, path) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.log(`auth info ${JSON.stringify(reqUser, null, 2)} DELETE path: ${path}`);
            return ret;
        });
    }
    parseId(resource, id) {
