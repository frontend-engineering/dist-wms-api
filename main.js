...
(function (UserError) {
    ...
    class UserNamePasswordMismatch extends flowda_shared_1.CustomError {
        constructor() {
            super(1003, 'Username and password mismatch');
        }
    }
    UserError.UserNamePasswordMismatch = UserNamePasswordMismatch;
    class UsePasswordNotInit extends flowda_shared_1.CustomError {
        constructor() {
            super(1004, "User's password is not initialized");
        }
    }
    UserError.UsePasswordNotInit = UsePasswordNotInit;
...
let UserService = UserService_1 = class UserService {
    ...
    validate(username, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!user.hashedPassword) {
                throw new error_code_1.UserError.UsePasswordNotInit();
            }
